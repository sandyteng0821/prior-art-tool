...
TARGET_PRODUCT = "Trospium 治療廣泛性膿皰型銀屑病 (GPP) / 銀屑病 (Psoriasis)"
...
TARGET_DRUG       = "Trospium（Non-selective muscarinic antagonist）"
TARGET_ROUTE      = "口服（Oral tablet / extended-release capsule）"
...
CUSTOM_QUERIES = [
    ...
    'ta=trospium AND ta="pustular psoriasis"',
    'ta=trospium AND ta="generalized pustular psoriasis"',
    'ta=sanctura AND ta=psoriasis',
