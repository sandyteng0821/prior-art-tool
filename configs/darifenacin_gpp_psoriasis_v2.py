...
TARGET_PRODUCT = "Darifenacin 治療廣泛性膿皰型銀屑病 (GPP) / 銀屑病 (Psoriasis)"
...
TARGET_DRUG       = "Darifenacin（M3R 拮抗劑 / IL-36 pathway）"
TARGET_ROUTE      = "口服（Oral tablet / extended-release）"
...
SCREENING_IRRELEVANT_EXAMPLES = (
    "膀胱過動症（overactive bladder）、尿失禁（urinary incontinence）、"
    "完全無 psoriasis / GPP / IL-36 相關的 general 抗膽鹼專利"
)
...
CUSTOM_QUERIES = [
    'ta=darifenacin AND ta=psoriasis',
    'ta=darifenacin AND ta="pustular psoriasis"',
    'ta=darifenacin AND ta="generalized pustular psoriasis"',
    ...
    'ta=enablex AND ta=psoriasis',
    'ta="muscarinic antagonist" AND ta=psoriasis',
    'ta="muscarinic antagonist" AND ta="generalized pustular psoriasis"',
    # M3-selective 競爭藥 × psoriasis/GPP
    'ta=solifenacin AND ta=psoriasis',
    'ta=solifenacin AND ta="generalized pustular psoriasis"',
    'ta=oxybutynin AND ta=psoriasis',
    'ta=trospium AND ta=psoriasis',
