...
TARGET_PRODUCT = "Solifenacin 治療廣泛性膿皰型銀屑病 (GPP) / 銀屑病 (Psoriasis)"
...
TARGET_DRUG       = "Solifenacin（M3R 選擇性拮抗劑）"
...
CUSTOM_QUERIES = [
    ...
    'ta=solifenacin AND ta="pustular psoriasis"',
    'ta=solifenacin AND ta="generalized pustular psoriasis"',
    'ta=vesicare AND ta=psoriasis',
